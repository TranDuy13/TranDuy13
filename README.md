...
<h3 align="center">Lead Fullstack Engineer / Tech Lead — NestJS & .NET · Next.js / React · React Native</h3>

<p align="center">
  I build <b>reusable platforms</b>, not just features — workflow engines, real-time collaborative editors,
  dynamic form builders, multi-tenant CMS, RBAC systems, and internal frameworks.
  Hands-on experience in the <b>e-government</b> domain (public service portals, digital identity, e-office)
  with strong demands on security, complex authorization, and large-scale document processing.
</p>
...
![Radix UI](https://img.shields.io/badge/Radix/shadcn-161618?style=flat&logo=radixui&logoColor=white)
...
![.NET](https://img.shields.io/badge/.NET_6/8-512BD4?style=flat&logo=dotnet&logoColor=white)
...
- **Windows Server (IIS):** `web.config` URL rewrite, SPA fallback, **ARR reverse proxy**, iisnode
- **Linux:** **Nginx** reverse proxy (TLS, gzip, static cache, WebSocket proxy) + **PM2 / systemd**, Docker / docker-compose
...
[![Email](https://img.shields.io/badge/Email-EA4335?style=flat&logo=gmail&logoColor=white)](mailto:duygtran1706@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/duy-tran-0aab81194)

<!--
TODO before publishing:
1. Replace YOUR_USERNAME with your GitHub username (for the stats cards).
2. Replace YOUR_PROFILE with your LinkedIn handle.
3. To use this as your GitHub profile README, create a repo named exactly
   like your username (e.g. github.com/duy/duy) and put this file there.
-->
